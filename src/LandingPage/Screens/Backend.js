...
import cv from '../../pdf/backend.pdf'
      ...
      <div className='course2-l'>
        ...
        <div className='course2-b'>
          ...
          <div className='curr'>
            ...
            <span>Introduction to Backend Development</span>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Building RESTful APIs</span>
            <span className='star'>*</span>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Working with Frameworks (e.g., Express.js, Django)</span>
            <span className='star'>*</span>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Asynchronous Programming and Concurrency</span>
            <span className='star'>*</span>
