...
import cv from '../../pdf/data-analysis.pdf'
      ...
      <div className='course2-l'>
        ...
        <div className='course2-b'>
          ...
          <div className='curr'>
            ...
            <span>Introduction to Data Analytics and Excel</span>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Excel Functions and Formulas</span>
            <span className='star'>*</span>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Introduction to Python for Data Analysis</span>
            <span className='star'>*</span>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Data Analysis and Visualization with Python</span>
            <span className='star'>*</span>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Introduction to SQL for Data Analytics</span>
            <span className='star'>*</span>
