...
import cv from '../../pdf/fullstack.pdf'
    ...
    <section className='course2'>
      <div className='course2-l'>
        ...
        <div className='course2-b'>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Frontend Development with HTML, CSS, and JavaScript</span>
            <span className='star'>*</span>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Frontend Frameworks with React.js</span>
            <span className='star'>*</span>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Server-side Rendering and Authentication</span>
            <span className='star'>*</span>
          ...
          <div className='curr'>
            <IoCheckmarkSharp className='cos-i'/>
            <span>Fullstack Development with PHP</span>
            <span className='star'>*</span>
